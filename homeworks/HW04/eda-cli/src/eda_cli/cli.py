...
def report(
    ...
    title: str = typer.Option("Визуализация результатов", help="Название графика"),
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Доля нулей для числовых значений высока: **{quality_flags['has_many_zero_values']}**\n\n")
        f.write("## Колонки\n\n")
    ...
    plot_missing_matrix(df, out_root / "missing_matrix.png", title_graph=title)
