...
- **Название проекта:** `Система для персонализированной коррекции терапии артериальной гипертензии 
на основе мониторинга АД`
- **ФИО:** `Николаева Алина Алексеевна`
- **Группа:** `ИНБО-20-24`
- **Контакт:** `@allliin`

- **Краткое описание (2-4 предложения):**  
  >Проект посвящён построению сервиса рекомендаций по коррекции терапии артериальной гипертензии на основе данных мониторинга артериального давления и клинических параметров пациентов. 
  >Используются открытые медицинские датасеты, простые модели машинного обучения и baseline-модели на основе клинических рекомендаций. 
  >Результат – REST API, который по идентификатору пациента возвращает рекомендации по коррекции дозировки и времени приема препаратов.
